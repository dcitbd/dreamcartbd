...
export const BulkPriceEngine = async () => {
  ...
  return `
    <div class="min-h-screen flex bg-slate-50 dark:bg-luxury-dark font-bengali">
      ${Sidebar.render("/admin/system/bulk")}
          ...
          <div class="lg:col-span-5 space-y-6">
            <div class="glass-panel p-6 sm:p-8 rounded-3xl space-y-4">
              <h3 class="text-base font-bold text-slate-900 dark:text-white pb-3 border-b border-slate-100 dark:border-slate-800">
                নতুন বাল্ক প্রাইস রুল প্রয়োগ
              </h3>

              <div>
                <label class="block text-xs font-bold text-slate-400 mb-1.5">টার্গেট ক্যাটাগরি *</label>
                <select id="bulk-target-cat" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-xs font-bold outline-none">
              ...
              <div>
                ...
                <select id="bulk-adjust-type" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-xs font-bold outline-none">
              ...
              <div>
                ...
                <input type="number" id="bulk-adjust-val" placeholder="যেমন: 10 (অর্থাৎ ১০% বা ১০ টাকা)" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-sm font-bold outline-none" />
              </div>

              <button onclick="window.applyBulkPriceRule()" class="w-full btn-primary py-3.5 text-sm font-bold flex items-center justify-center gap-2 shadow-lg shadow-brand-500/25">
            ...
            <div class="glass-panel p-6 sm:p-8 rounded-3xl space-y-4">
              ...
              <div class="space-y-3">
                <div class="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800 flex items-center justify-between">
                  <div>
                    <span class="badge-success text-[10px] mb-1">সফলভাবে সম্পন্ন</span>
                    <h4 class="text-sm font-bold text-slate-900 dark:text-white">ইলেকট্রনিক্স ক্যাটাগরিতে +৫% প্রাইস বৃদ্ধি</h4>
                    <p class="text-[10px] text-slate-400">প্রভাবিত প্রোডাক্ট: ৪৫ টি | তারিখ: ${new Date().toLocaleDateString()}</p>
                  </div>
                  <button onclick="window.store.showToast('পূর্বের মূল্যে সফলভাবে রোলব্যাক করা হয়েছে!', 'success')" class="btn-secondary text-xs px-3 py-1.5 text-rose-500 hover:text-rose-600">
                    রোলব্যাক করুন
                  </button>
                </div>
              </div>
...
window.applyBulkPriceRule = () => {
  store.showToast("বাল্ক প্রাইস রুল গুগল শীটে সফলভাবে কার্যকর হয়েছে!", "success");
};
