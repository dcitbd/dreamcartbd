    ...
    <div class="min-h-screen flex bg-slate-50 dark:bg-luxury-dark font-bengali">
      ...
      <main class="flex-1 p-6 sm:p-10 max-w-7xl mx-auto overflow-y-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 mb-8 border-b border-slate-200 dark:border-slate-800">
          ...
          <button onclick="window.downloadSampleExcel()" class="btn-secondary py-2.5 px-4 text-xs font-bold flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div class="lg:col-span-5 space-y-6">
            <div class="glass-panel p-8 rounded-3xl border-2 border-dashed border-slate-300 dark:border-slate-700 text-center space-y-4 hover:border-brand-500 transition-colors cursor-pointer">
              ...
              <button onclick="document.getElementById('bulk-file-input').click()" class="btn-primary py-2 px-5 text-xs">
                ফাইল ব্রাউজ করুন
              </button>
            </div>

            <!-- Import Guidelines -->
            <div class="glass-panel p-6 rounded-3xl space-y-2 text-xs text-slate-600 dark:text-slate-300">
              ...
              <p class="flex items-center gap-2"><i data-lucide="check" class="w-3.5 h-3.5 text-emerald-500"></i> ডুপ্লিকেট SKU স্বয়ংক্রিয়ভাবে স্কিপ বা আপডেট হবে।</p>
          ...
          <div class="lg:col-span-7">
            <div class="glass-panel p-6 rounded-3xl space-y-4">
              <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
                ...
                <span id="preview-row-count" class="badge-success text-xs">০ টি রো রেডি</span>
              </div>

              <div class="h-64 rounded-2xl bg-slate-50 dark:bg-slate-900/60 border border-slate-100 dark:border-slate-800 flex items-center justify-center text-slate-400 text-xs">
                কোনো ফাইল আপলোড করা হয়নি। ফাইল ড্রপ করলে ডাটা প্রিভিউ এখানে দেখাবে।
              </div>

              <button onclick="window.store.showToast('গুগল শীটে সফলভাবে ইমপোর্ট সম্পন্ন হয়েছে!', 'success')" class="w-full btn-primary py-3.5 text-sm font-bold flex items-center justify-center gap-2">
