      ...
      <main class="flex-1 p-6 sm:p-10 max-w-5xl mx-auto overflow-y-auto">
        ...
        <div class="flex items-center justify-between pb-6 mb-8 border-b border-slate-200 dark:border-slate-800">
          <div>
            ...
            <p class="text-xs text-slate-500 mt-1">ফিচার ফ্ল্যাগ এবং ই-কমার্স অপারেশন রুলস নিয়ন্ত্রণ করুন</p>
          </div>
          <button onclick="window.saveGlobalSettings()" class="btn-primary py-2.5 px-5 text-xs font-bold shadow-lg shadow-brand-500/25">
            সেটিংস সেভ করুন
          </button>
        </div>
        ...
        <div class="space-y-6">
          ...
          <div class="glass-panel p-6 sm:p-8 rounded-3xl space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div>
                ...
                <input type="text" value="Dream Cart BD" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 outline-none" />
              </div>
              <div>
                <label class="block font-bold text-slate-400 mb-1">কারেন্সি সিম্বল</label>
                <input type="text" value="৳ (BDT)" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 outline-none" />
              </div>
            </div>
          </div>
          ...
          <div class="glass-panel p-6 sm:p-8 rounded-3xl space-y-4">
            ...
            <div class="divide-y divide-slate-100 dark:divide-slate-800 text-xs">
              ...
              <div class="py-3 flex items-center justify-between">
                <div>
                  <h4 class="font-bold text-slate-900 dark:text-white">স্বয়ংক্রিয় কুরিয়ার ফ্রড চেক</h4>
                  <p class="text-slate-400">অর্ডার প্লেস হওয়ার সাথে সাথে কাস্টমারের পূর্বের ডেলিভারি হিস্ট্রি যাচাই</p>
                </div>
                <input type="checkbox" checked class="rounded text-brand-600 focus:ring-brand-500 w-4 h-4 cursor-pointer" />
              </div>
            </div>
...
window.saveGlobalSettings = () => {
  store.showToast("গ্লোবাল সেটিংস ও ফিচার ফ্ল্যাগ সফলভাবে গুগল শীটে সেভ হয়েছে!", "success");
};
